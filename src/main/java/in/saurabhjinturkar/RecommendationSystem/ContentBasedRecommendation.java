...
public class ContentBasedRecommendation {
	...
	public long[] RecommendMoviesBasedOnContent(int userId, int[] movieID, int howMany){
		...
		try {
			...
			mostSimilarUserIDs = recommender.mostSimilarUserIDs(id, howMany);
